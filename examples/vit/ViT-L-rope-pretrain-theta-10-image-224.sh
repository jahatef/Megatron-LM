...
DATA_ARGS=(
    --data-path "/home/hatef.4/datasets/inat-1k-flat"
...
EVAL_AND_LOGGING_ARGS=( 
    --log-interval 20
    --save-interval 40 #313 
    --eval-interval 40 #313 
    --eval-iters 40
    --tensorboard-log-interval 20
    --save "/home/hatef.4/megatron/Megatron-LM/checkpoints-warmup-224-test"
    ...
    --wandb-exp-name warmup-224-test-val-copy
)
