...
DATA_ARGS=(
    --data-path "/home/hatef.4/imagenet-1k/ILSVRC_subset_128/train"
...
EVAL_AND_LOGGING_ARGS=( 
    ...
    --save "/home/hatef.4/megatron/Megatron-LM/checkpoints-imagenet-warmup-224-imagenet"
    ...
    --wandb-exp-name warmup-imagenet-224-imagenet
)
